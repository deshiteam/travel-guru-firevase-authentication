                    ...
                    <div className='form-style'>
                        ...
                        {user.success && <p style={{ color: 'green' }}>User {newUser ? "created" : "Logged in successfully"}</p>}
                        {
                            user.isSignedIn
                                ...
                                : <button style={{ marginBottom: '2%', height: '40px', backgroundColor: 'white', borderRadius: '20px', width: '300px', lineHeight: '30px', marginLeft: '25%' }} onClick={googleSignIn}> <img src={googleLogo} alt="" width='30px' />  LogIn With Google</button>
                        }
                        <button style={{ height: '40px', marginLeft: '25%', backgroundColor: 'white', borderRadius: '20px', width: '300px', lineHeight: '30px' }} onClick={fbSignIn}> <img src={facebookLogo} alt="" width='30px' /> LogIn With Facebook</button>
